...
1. Data importation -> import the time-series
2. Stationarity -> performing basic stationarity tests
3. Probability Density Function -> calculate and plot the PDF of the data, check if it has a gaussian behavior